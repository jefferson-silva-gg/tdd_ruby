...
describe Password, type: :unit do
  context 'when use password classe' do
    it 'should create a valid password' do
      ...
      expect(password.value).to eq('0b74f70c40596a00f0736dc16f6afafee623c081a48acf24a4fffc5d5957a821e277dc5b5ffb8ff507c9dd3b05c7b7f66dff94b39205afe4e5b40d3aa36a1973')
    end
